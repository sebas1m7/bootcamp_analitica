...
escoger=input("desea solo buscar o descargar los datos")
if escoger.lower()=="buscar":
...
elif escoger.lower()=="descargar":
        #///////////////////////////////////////////////////////////////////////////////////
        busqueda = input("¿Desea descargar el archivo total por Marca o por Supervisor o por pais?: ")
        ...
        if busqueda.lower() == "marca":
            ...
            if not resultados.empty:
                ...
                nombre_archivo = input("\n¿Cómo desea llamar al archivo (sin extensión)? ").strip()
                resultados.to_excel(f"{nombre_archivo}.xlsx", index=False)
                print(f"\nArchivo '{nombre_archivo}.xlsx' guardado correctamente.")
            ...
            if not resultados1.empty:
                ...
                print(resultados1)
                nombre_archivo = input("\n¿Cómo desea llamar al archivo (sin extensión)? ").strip()
                resultados1.to_excel(f"{nombre_archivo}.xlsx", index=False)
                print(f"\nArchivo '{nombre_archivo}.xlsx' guardado correctamente.")
            else:
                print(f"ERROR para encontar el supervisor '{dato1}'")
        elif busqueda.lower() == "pais":
            ...
            if not resultados2.empty:
                ...
                print(resultados2)
                nombre_archivo = input("\n¿Cómo desea llamar al archivo (sin extensión)? ").strip()
                resultados2.to_excel(f"{nombre_archivo}.xlsx", index=False)
                print(f"\nArchivo '{nombre_archivo}.xlsx' guardado correctamente.")
            else:
                print(f"ERROR para encontar el pais '{dato2}'")
    ...
    todo=input("desea descargar todo el archivo")
    if todo == "si":
     df1=df.to_excel('todo.xlsx', index=False)
    print("descargado todo con exito")